	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 f1 1d 80 00 	movsbl 0x801df1(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002f2:	ff 24 85 40 1f 80 00 	jmp    *0x801f40(,%eax,4)
  ...
  8003b2:	8b 14 85 a0 20 80 00 	mov    0x8020a0(,%eax,4),%edx
  8003b9:	85 d2                	test   %edx,%edx
  8003bb:	75 18                	jne    8003d5 <vprintfmt+0x15d>
				printfmt(putch, putdat, "error %d", err);
  8003bd:	50                   	push   %eax
  8003be:	68 09 1e 80 00       	push   $0x801e09
  8003c3:	53                   	push   %ebx
  8003c4:	56                   	push   %esi
  ...
  8003d5:	52                   	push   %edx
  8003d6:	68 d1 21 80 00       	push   $0x8021d1
  8003db:	53                   	push   %ebx
  8003dc:	56                   	push   %esi
  ...
  8003fa:	b8 02 1e 80 00       	mov    $0x801e02,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a90:	68 ff 20 80 00       	push   $0x8020ff
  800a95:	6a 23                	push   $0x23
  800a97:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b11:	68 ff 20 80 00       	push   $0x8020ff
  800b16:	6a 23                	push   $0x23
  800b18:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b53:	68 ff 20 80 00       	push   $0x8020ff
  800b58:	6a 23                	push   $0x23
  800b5a:	68 1c 21 80 00       	push   $0x80211c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800b95:	68 ff 20 80 00       	push   $0x8020ff
  800b9a:	6a 23                	push   $0x23
  800b9c:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bd7:	68 ff 20 80 00       	push   $0x8020ff
  800bdc:	6a 23                	push   $0x23
  800bde:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c19:	68 ff 20 80 00       	push   $0x8020ff
  800c1e:	6a 23                	push   $0x23
  800c20:	68 1c 21 80 00       	push   $0x80211c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c5b:	68 ff 20 80 00       	push   $0x8020ff
  800c60:	6a 23                	push   $0x23
  800c62:	68 1c 21 80 00       	push   $0x80211c
...
sys_ipc_recv(void *dstva)
{
  ...
  800cbf:	68 ff 20 80 00       	push   $0x8020ff
  800cc4:	6a 23                	push   $0x23
  800cc6:	68 1c 21 80 00       	push   $0x80211c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dad:	ba a8 21 80 00       	mov    $0x8021a8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800dd8:	51                   	push   %ecx
  800dd9:	50                   	push   %eax
  800dda:	68 2c 21 80 00       	push   $0x80212c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801002:	53                   	push   %ebx
  801003:	50                   	push   %eax
  801004:	68 6d 21 80 00       	push   $0x80216d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010d7:	53                   	push   %ebx
  8010d8:	50                   	push   %eax
  8010d9:	68 89 21 80 00       	push   $0x802189
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80118c:	53                   	push   %ebx
  80118d:	50                   	push   %eax
  80118e:	68 4c 21 80 00       	push   $0x80214c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8013ef:	68 b8 21 80 00       	push   $0x8021b8
  8013f4:	68 bf 21 80 00       	push   $0x8021bf
  8013f9:	6a 7c                	push   $0x7c
  8013fb:	68 d4 21 80 00       	push   $0x8021d4
  801400:	e8 bd 05 00 00       	call   8019c2 <_panic>
	assert(r <= PGSIZE);
  801405:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80140a:	7e 16                	jle    801422 <devfile_read+0x65>
  80140c:	68 df 21 80 00       	push   $0x8021df
  801411:	68 bf 21 80 00       	push   $0x8021bf
  801416:	6a 7d                	push   $0x7d
  801418:	68 d4 21 80 00       	push   $0x8021d4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8014fb:	68 eb 21 80 00       	push   $0x8021eb
  801500:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015ab:	50                   	push   %eax
  8015ac:	56                   	push   %esi
  8015ad:	68 f2 21 80 00       	push   $0x8021f2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80184f:	68 0a 22 80 00       	push   $0x80220a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8019de:	56                   	push   %esi
  8019df:	50                   	push   %eax
  8019e0:	68 18 22 80 00       	push   $0x802218
  ...
  8019f1:	e8 fa e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  8019f6:	c7 04 24 03 22 80 00 	movl   $0x802203,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801a80:	50                   	push   %eax
  801a81:	68 3c 22 80 00       	push   $0x80223c
  801a86:	6a 40                	push   $0x40
  801a88:	68 4e 22 80 00       	push   $0x80224e
