...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba 74 1e 80 00       	mov    $0x801e74,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 f8 1d 80 00       	push   $0x801df8
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 39 1e 80 00       	push   $0x801e39
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 55 1e 80 00       	push   $0x801e55
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 18 1e 80 00       	push   $0x801e18
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a6e:	68 84 1e 80 00       	push   $0x801e84
  800a73:	68 8b 1e 80 00       	push   $0x801e8b
  800a78:	6a 7c                	push   $0x7c
  800a7a:	68 a0 1e 80 00       	push   $0x801ea0
  800a7f:	e8 bd 05 00 00       	call   801041 <_panic>
	assert(r <= PGSIZE);
  800a84:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a89:	7e 16                	jle    800aa1 <devfile_read+0x65>
  800a8b:	68 ab 1e 80 00       	push   $0x801eab
  800a90:	68 8b 1e 80 00       	push   $0x801e8b
  800a95:	6a 7d                	push   $0x7d
  800a97:	68 a0 1e 80 00       	push   $0x801ea0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b7a:	68 b7 1e 80 00       	push   $0x801eb7
  800b7f:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c2a:	50                   	push   %eax
  800c2b:	56                   	push   %esi
  800c2c:	68 be 1e 80 00       	push   $0x801ebe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ece:	68 d6 1e 80 00       	push   $0x801ed6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80105d:	56                   	push   %esi
  80105e:	50                   	push   %eax
  80105f:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  801070:	e8 54 00 00 00       	call   8010c9 <vcprintf>
	cprintf("\n");
  801075:	c7 04 24 cf 1e 80 00 	movl   $0x801ecf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011c8:	0f be 80 07 1f 80 00 	movsbl 0x801f07(%eax),%eax
  8011cf:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801396:	50                   	push   %eax
  801397:	68 1f 1f 80 00       	push   $0x801f1f
  80139c:	53                   	push   %ebx
  80139d:	56                   	push   %esi
  ...
  8013ae:	52                   	push   %edx
  8013af:	68 9d 1e 80 00       	push   $0x801e9d
  8013b4:	53                   	push   %ebx
  8013b5:	56                   	push   %esi
  ...
  8013d3:	b8 18 1f 80 00       	mov    $0x801f18,%eax
